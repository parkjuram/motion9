...
urlpatterns = patterns('',
                       ...
                       url(r'^check/email/$', 'users.views.check_email_view', name='check_email'),
                       url(r'^check/token/facebook/$', 'users.views.check_facebook_token_view',
                           name='check_facebook_token'),
                       ...
                       url(r'^mobile/registration_page/$', 'users.views.mobile_registration_view',
                           name='mobile_registration_page'),
                       ...
                       url(r'^mypage/purchase/(?P<page_num>(\d+))/$', 'users.views.mypage_purchase_view',
                           name='mypage_purchase'),
                       ...
                       url(r'^billgate/checksum/$', 'users.views.billgate_payment_checksum',
                           name='billgate_payment_checksum'),
                       ...
                       url(r'^mobile/mypage/myinfo/$', 'users.views.mobile_mypage_myinfo_view',
                           name='mobile_mypage_myinfo'),

                       url(r'^mobile/mypage/set/$', 'users.views.mobile_mypage_set_view', name='mobile_mypage_set'),
                       url(r'^mobile/mypage/set/(?P<page_num>(\d+))/$', 'users.views.mobile_mypage_set_view',
                           name='mobile_mypage_set'),

                       url(r'^mobile/mypage/product/$', 'users.views.mobile_mypage_interesting_view',
                           name='mobile_mypage_product'),
                       url(r'^mobile/mypage/product/(?P<page_num>(\d+))/$',
                           'users.views.mobile_mypage_interesting_view', name='mobile_mypage_product'),

                       url(r'^mobile/mypage/purchase/$', 'users.views.mobile_mypage_purchase_list_view',
                           name='mobile_mypage_purchase_list'),

                       url(r'^mobile/mypage/before_purchase/$', 'users.views.mobile_mypage_before_purchase_view',
                           name='mobile_mypage_before_purchase'),
                       ...
                       url(r'^mobile/mypage/edit/$', 'users.views.mobile_mypage_myinfo_edit_view',
                           name='mobile_mypage_myinfo_edit'),

                       url(r'^mobile/report/$', 'users.views.mobile_report_view', name='mobile_report'),

                       url(r'^mobile/report/form/index/$', 'users.views.mobile_report_form_index_view',
                           name='mobile_report_form_index'),

                       url(r'^mobile/report/form/$', 'users.views.mobile_report_form_view', name='mobile_report_form'),

                       url(r'^mobile/report/detail/(?P<product_id>(\d+))/$', 'users.views.mobile_report_detail_view',
                       ...
                       url(r'^confirm/(?P<activation_key>\w+)/', 'users.views.register_confirm',
